...
<<<<<<< HEAD
      <div className="page-header"><div><h1>Inventory In History</h1><p className="page-subtitle">{currentBranch?.name || 'All Branches'}</p></div></div>
=======
      <div className="page-header"><div><h1>Purchase History</h1><p className="page-subtitle">{currentBranch?.name || 'All Branches'}</p></div></div>
...
<<<<<<< HEAD
          <thead><tr><th>Date</th><th>Invoice No.</th><th>Ref. No.</th><th className="text-right">Items</th><th className="text-right">Qty In</th><th className="text-right">Amount</th><th>Status</th></tr></thead>
=======
          <thead><tr><th>Date</th><th>Invoice No.</th><th>Supplier Inv.</th><th>Supplier</th><th className="text-right">Amount</th><th>Status</th></tr></thead>
>>>>>>> f709e2d3170230ace218f088f0c7a65d0a20ad68
          <tbody>
            {invoices.map(inv => (
              <tr key={inv.id}>
